										    ...
										    <div class="sc_form_style_form_2">
												...
												<div class="sc_form_descr sc_item_descr">Organic Store is your source for healthy way of living. We welcome you at our facility at any time!</div>  
										       			<div class="form-style-8">
															<form id="ForgetPassword" method="post" action="<?php echo base_url(); ?>index.php/home/FarmerLoginController/checkFarmerNumber">
																	<input type="text" id="txtfarmerphno" name="txtfarmerphno" placeholder="Farmer Contact Number" />
																	<button type="submit" id="btninsert" name="btninsert">Reset Password</button>
																</form>
															</div>
													    </form>										                
										            </div>
	...
	<script type="text/javascript">
		...
		<script>
			$("#ForgetPassword").validate({
				...
				messages: {
					txtfarmerphno: {
						required:"Farmer Contact is required",
						number:"Farmer Contact must contain number"
						}
				}
			});
