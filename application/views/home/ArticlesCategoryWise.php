	...
	<div class="body_wrap">
		<div class="page_wrap">
			...
			<div class="page_content_wrap page_paddings_yes">
				<div class="content_wrap">
					<div class="content">
					<?php foreach($showArticleData as $item) { ?>
						...
						<nav id="pagination" class="pagination_wrap pagination_pages">
						    <span class="pager_current active ">1</span><a href="#" class="">2</a><a href="#" class="">3</a><a href="#" class="pager_next "></a><a href="#" class="pager_last "></a>
						</nav>
					</div>
  ...
  <div class="sidebar_inner widget_area_inner">
    <aside class="widget widget_categories">
	  ...
	  <?php foreach($articleCatData as $item) { ?>
        <li class="cat-item">
          <a id="showArticleCategoryWise" href="<?php echo base_url(); ?>index.php/home/ArticleController/showCategory/<?php echo str_replace("/","-",$this->encryption->encrypt($item->CategoryId)); ?>" ><?php echo $item->CategoryName; ?></a>
		</li>
		<?php } ?>
      </ul>
    </aside>
    ...
    <aside class="widget widget_text">
      ...
      <div class="textwidget">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisquam, magni commodi fugit in quo provident.</div>
    </aside>
