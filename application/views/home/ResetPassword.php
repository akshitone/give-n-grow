...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?php echo base_url(); ?>client_plugin/assets/images/favicon.png" /><title>GiveNGrow | Reset Password</title>
										    ...
										    <div class="sc_form_style_form_2">
												...
												<div class="sc_form_descr sc_item_descr">Organic Store is your source for healthy way of living. We welcome you at our facility at any time!</div>  
										       			<div class="form-style-8">
															<form id="ResetPassword" method="post" action="<?php echo base_url(); ?>index.php/home/FarmerLoginController/updatepassword">
                                                                    ...
                                                                    <input type="password" id="txtconfirmpassword" name="txtconfirmpassword" placeholder="Retype Password"> 
																	<button type="submit" id="btninsert" name="btninsert">Confirm Password</button>
																</form>
															</div>
													    </form>										                
										            </div>
