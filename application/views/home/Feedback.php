...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?php echo base_url(); ?>client_plugin/assets/images/favicon.png" /><title>GiveNGrow | Feedback</title>
										...
										<div class="sc_form_wrap">
										    <div class="sc_form_style_form_2">
												<h2 class="sc_form_title sc_item_title">
													<b>Give Feedback</b> To Us
												</h2>
												<div class="sc_form_descr sc_item_descr">Give N Grow is your source for healthy way of living. We welcome you at our facility at any time!</div>  
										       			<div class="form-style-8">
															<form id="FeedbackForm" method="post" action="<?php echo base_url(); ?>index.php/home/FeedbackController/insertData">
																	<input type="text" id="txtusername" name="txtusername" placeholder="Name" />
																	<input type="email" id="txtemail" name="txtemail" placeholder="Email" />
																	<textarea id="txtfeedback" name="txtfeedback" placeholder="Feedback" onkeyup="adjust_textarea(this)"></textarea><br>
																	<button type="submit" id="btninsert" name="btninsert">Give Feedback</button>
																</form>
															</div>
													    </form>										                
										            </div>
			...
			$("#FeedbackForm").validate({
				...
				messages: {
					txtcattype: {
						...
						nameRegex:"Username must contain only letters & space"
						},
					txtemail: {
						required:"Email is required",
						email:"Invalid Email"
					},
					txtfeedback: "Feedback is required"
				}
			});
