					...
					<section class="page-content container-fluid">
						<div class="row">
							<div class="col">
								<div class="card">
									<div class="card-body">
										<form method="post"  enctype="multipart/form-data" id="BuyerForm" action="<?php echo base_url(); ?>index.php/agency/BuyerController/updateData" class="form-horizontal">
										<?php foreach($buyerData as $item) { ?>
											<div class="form-body">
														<input type="hidden" name="txtbuyerid" value="<?php echo $item->BuyerId; ?>"/>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Buyer Name</label>
													<div class="col-md-5">
														<input type="text" id="txtbuyername" name="txtbuyername" value="<?php echo $item->BuyerName; ?>" placeholder="Buyer name" class="form-control input-rounded" autocomplete="given-name">
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-md-5">
														<div class="custom-file">
															<input type="file" id="txtbuyericon" name="txtbuyericon" class="custom-file-input" >
															<label class="custom-file-label" for="validatedCustomFile"><?php echo $item->BuyerIcon; ?></label>
															<div class="invalid-feedback">Example custom file feedback</div>
														</div>
													</div>
													<span><img src="<?php echo base_url(); ?>/uploads/buyer/<?php echo $item->BuyerIcon; ?>" style="height:75px; width:75px;" class="w-75 rounded-circle"/></span>
												</div>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Contact</label>
													<div class="col-md-5">
														<input type="text" id="txtbuyercontact" name="txtbuyercontact"  value="<?php echo $item->BuyerContact; ?>" placeholder="Contact no" class="form-control input-rounded" autocomplete="family-name">
													</div>
												</div>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Address</label>
													<div class="col-md-5">
														<textarea id="txtbuyeraddress" name="txtbuyeraddress"  placeholder="Address" class="form-control input-rounded" id="exampleFormControlTextarea1" rows="3"><?php echo $item->BuyerAddress; ?></textarea>
													</div>
												</div>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Buyer Code</label>
													<div class="col-md-5">
														<input type="text" id="txtbuyercode" name="txtbuyercode" value="<?php echo $item->BuyerCode; ?>" placeholder="Buyer code" class="form-control input-rounded" autocomplete="family-name">
													</div>
												</div>
											<?php } ?>
										</div>
