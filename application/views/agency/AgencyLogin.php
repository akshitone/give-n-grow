...
<head>
	...
	<title>GiveNGrow | Agency Login</title>
	<!-- ================== GOOGLE FONTS ==================-->
...
<body>
	<div class="container">
		<form class="sign-in-form" method="post" action="<?php echo base_url(); ?>index.php/agency/AgencyLoginController/dologin">
			<div class="card">
				<div class="card-body">
					<?php
					...
					<h5 class="sign-in-heading text-center m-b-20">Sign in to your account &nbsp;<span class="badge badge-accent">AGENCY</span> </h5>
					...
					<div class="checkbox m-b-10 m-t-20">
						...
						<a href="<?php echo base_url(); ?>index.php/agency/AgencyLoginController/ForgetPassword" class="float-left">Forgot Password?</a>
					</div>
				</div>
			</div>
		</form>
