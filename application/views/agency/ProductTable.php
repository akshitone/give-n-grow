										...
										foreach ($productData as $item) { ?>
											<tr>
												...
												<td><?php $date = date_create($item->ProductAddedDate);
													...
													?></td>
												<td><a href="<?php echo base_url(); ?>index.php/agency/ProductController/view/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->ProductId)); ?>" class="btn btn-info btn-rounded btn-floating btn-outline">View</a></td>
											</tr>
										<?php $count++;
										} ?>
									</tbody>
