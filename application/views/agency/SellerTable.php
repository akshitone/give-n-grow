...
<head>
	...
	<title>GiveNGrow | Seller Table</title>
	<!-- ================== GOOGLE FONTS ==================-->
									...
									<tbody>
										...
										foreach ($sellerData as $item) { ?>
											<tr>
												...
												<td><a href="<?php echo base_url(); ?>index.php/agency/SellerController/delete/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->SellerId)); ?>" class="btn btn-danger btn-rounded btn-floating btn-outline">Delete</a></td>
											</tr>
										<?php $c++;
										} ?>
									</tbody>
