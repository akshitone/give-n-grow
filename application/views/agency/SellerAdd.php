...
<head>
	...
	<title>GiveNGrow | Seller Add</title>
	<!-- ================== GOOGLE FONTS ==================-->
	...
	<div id="app">
				...
				<div class="content container-fluid">
					<header class="page-header">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h1 class="separator">Seller Inputs</h1>
								<nav class="breadcrumb-wrapper" aria-label="breadcrumb">
									<ol class="breadcrumb">
										<li class="breadcrumb-item"><a href="index-2.html"><i class="icon dripicons-home"></i></a></li>
										<li class="breadcrumb-item"><a href="javascript:void(0)">Forms</a></li>
										<li class="breadcrumb-item active" aria-current="page">Seller Inputs</li>
									</ol>
								</nav>
							</div>
						</div>
					...
					<section class="page-content container-fluid">
								...
								<div class="card">
									<div class="card-body">
												<div class="form-group row">
													...
													<div class="col-md-5">
														<input type="text" id="txtbuyerid" name="txtbuyerid" autofocus="autofocus" placeholder="Scan Buyer" onChange="getCode(this.value);" class="form-control input-rounded" autocomplete="family-name" value="">
													</div>
												</div>
									<form id="SellerForm" name="myform" method="post" action="<?php echo base_url(); ?>index.php/agency/SellerController/insertData"  class="form-horizontal">
												<?php
										if(isset($_REQUEST["btninsert"]))
										{
											...
											<div class="form-body">
												...
												<div class="form-group row">
													...
													<div class="col-md-5">
														<select id="txtprodtype" name="txtprodtype" class="form-control input-rounded" onChange="getProductPrice(this.value);getStorage(this.value);getSell(this.value);" id="txtprodtype">
												...
												<div class="form-group row">
													...
													<div class="col-md-5">
														<input type="text" id="txtpriceamt" name="txtpriceamt" id="txtpriceamt" placeholder="Enter Price Amount" class="form-control input-rounded" autocomplete="family-name" readonly="readonly" value="">
													</div>
												</div>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Weight</label>
													<div class="col-md-5">
														<input type="text" id="txtweight" name="txtweight" placeholder="Enter Weight" onBlur="mul();" onChange="checkWeight(this.value);" class="form-control input-rounded" autocomplete="family-name" value="">
													</div>
						...
						<div id="showBuyer" class="col-md-6">

						</div>
						<div id="showStorage" class="col-md-6">
																
						</div>
						<div id="showSell" class="col-md-6">
		...
		<script>
			...
			$("#SellerForm").validate({
				...
				messages: {
					txtbuyerid: "Buyer Code is required",
		...
		<script type="text/javascript">
				function mul() {
					...
					document.getElementById('txttotpayment').value = txtpriceamt*txtweight;
						...
						{
							var pid=document.getElementById("txtproductid").value;
							var type=document.getElementById("txtprodtype").value;
										 var xhttp = new XMLHttpRequest();
								 	 xhttp.onreadystatechange = function() {
									 if (this.readyState == 4 && this.status == 200) {
									 document.getElementById("checkWeight").innerHTML = this.responseText;
									 }
								  };
								  xhttp.open("POST", "<?php echo base_url(); ?>index.php/agency/SellerController/checkWeight/"+pid+"/"+type+"/"+weight, true);
								  xhttp.send();
						}
						function getStorage(type)
						{
							...
							else
							{
								 var xhttp = new XMLHttpRequest();
								  xhttp.onreadystatechange = function() {
								  if (this.readyState == 4 && this.status == 200) {
									  document.getElementById("showStorage").innerHTML = this.responseText;
									  }
								  };
								  xhttp.open("POST", "<?php echo base_url(); ?>index.php/agency/SellerController/getStorage/"+pid+"/"+type, true);
								  xhttp.send();
							}
						}
						function getSell(type)
						{
							var pid=document.getElementById("txtproductid").value;
							if(pid=="0")
							{
							...
							else
							{
								 var xhttp = new XMLHttpRequest();
								  xhttp.onreadystatechange = function() {
								  if (this.readyState == 4 && this.status == 200) {
									  document.getElementById("showSell").innerHTML = this.responseText;
									  }
								  };
								  xhttp.open("POST", "<?php echo base_url(); ?>index.php/agency/SellerController/getSell/"+pid+"/"+type, true);
								  xhttp.send();
							}
						}
						function getCode(bcode)
						{
							var bid=document.getElementById("txtbuyerid").value;
							$('#bid').val(bcode);
										 var xhttp = new XMLHttpRequest();
								 	 xhttp.onreadystatechange = function() {
									 if (bid=="NULL") {
									 document.getElementById("showBuyer").style.visibility="visible";
									 }
									 else
									 {
										document.getElementById("showBuyer").innerHTML = this.responseText;
									 }
								  };
								  xhttp.open("POST", "<?php echo base_url(); ?>index.php/agency/SellerController/getBuyerCode/"+bcode, true);
								  xhttp.send();
						}
