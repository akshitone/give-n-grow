                            ...
                            <ul class="actions top-right">
                                <li class="dropdown">
                                    ...
                                    <div class="dropdown-header">
                                        ...
                                        <a href="<?php echo base_url(); ?>index.php/agency/NotificationController/addFarmer" class="dropdown-item">
                                                                <i class="icon dripicons-clockwise"></i> Farmer Notification
                                                            </a>
                                        <a href="<?php echo base_url(); ?>index.php/agency/NotificationController/addExpert" class="dropdown-item">
					...
					<section class="page-content container-fluid">
						<div class="row">
							<div class="col">
								<div class="card">
									<div class="card-body">
										<form method="post" id="ExpertForm" action="<?php echo base_url(); ?>index.php/agency/NotificationController/insertExpert" enctype="multipart/form-data" class="form-horizontal">
											<?php
											...
											<div class="form-body">
												<div class="form-group row">
													...
													<div class="col-md-5">
														<select id="txtexpertid" name="txtexpertid" class="form-control input-rounded">
															<option>Select Expert</option>
															<?php
																foreach($expertData as $item)
																{
															?>
															<option value="<?php echo $item->ExpertId; ?>"><?php echo $item->ExpertName; ?></option>
															<?php } ?>
														</select>
													</div>
												</div>
