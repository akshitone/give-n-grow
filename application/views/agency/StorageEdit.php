					...
					<section class="page-content container-fluid">
						<div class="row">
							<div class="col">
								<div class="card">
									<div class="card-body">
										<form method="post" action="<?php echo base_url(); ?>index.php/agency/StorageController/updateData" class="form-horizontal">
											<div class="form-body">
											<div class="form-group row">
													<label class="control-label text-right col-md-3">Farmer Name</label>
													<div class="col-md-5">
														<select name="txtfarmerid" class="form-control input-rounded">
											...
											<?php foreach($storageData as $item) { ?>
														<input type="hidden" name="txtstorageid" value="<?php echo $item->StorageId; ?>"/>
														<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-md-5">
														<input type="text" id="txtpriceamt" name="txtpriceamt" value="<?php echo $item->ProductPrice; ?>" id="txtpriceamt" placeholder="Enter Price Amount" class="form-control input-rounded" autocomplete="family-name" value="">
													</div>
												</div>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Weight</label>
													<div class="col-md-5">
														<input type="text" id="txtweight" name="txtweight" value="<?php echo $item->Weight; ?>" placeholder="Enter Weight" onBlur="mul();" class="form-control input-rounded" autocomplete="family-name" value="">
													</div>
												...
												<div class="form-group row">
													...
													<div class="col-md-5">
														<input type="text" id="txttotpayment" name="txttotpayment" value="<?php echo $item->TotalPayment; ?>" placeholder="Total Payment" class="form-control input-rounded" autocomplete="family-name" readonly="readonly" value="">
													</div> 
												</div>
											</div>
										<?php } ?>
