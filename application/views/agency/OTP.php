...
<body class="content-menu">
	<div class="container">
		<form id="ForgetPassword" class="sign-in-form" method="post" action="<?php echo base_url(); ?>index.php/agency/AgencyLoginController/CheckOTPCode">
			<div class="card">
				<div class="card-body">
				<?php
					...
					<div class="form-group">
						...
						<input type="password" name="txtotp" id="txtotp" class="form-control" placeholder="Enter OTP">
					</div>
