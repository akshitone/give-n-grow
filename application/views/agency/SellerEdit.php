				...
				<div class="content container-fluid">
					<header class="page-header">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h1 class="separator">Seller Edit</h1>
					...
					<section class="page-content container-fluid">
						<div class="row">
							<div class="col">
								<div class="card">
									<div class="card-body">
										<form method="post" action="<?php echo base_url(); ?>index.php/agency/SellerController/updateData" class="form-horizontal">
											<div class="form-body">
												
											<div class="form-group row">
													<label class="control-label text-right col-md-3">Buyer Name</label>
													<div class="col-md-5">
														<select name="txtbuyerid" class="form-control input-rounded">
														<option>Select Buyer</option>
														<?php
														foreach($buyerData as $item)
														{
														?>
													<option value="<?php echo $item->BuyerId; ?>"><?php echo $item->BuyerName; ?></option>	
														<?php } ?>
														</select>
													</div>
												</div>
											...
											<?php foreach($sellerData as $item) { ?>
														<input type="hidden" name="txtsellerid" value="<?php echo $item->SellerId; ?>"/>
														<div class="form-group row">
