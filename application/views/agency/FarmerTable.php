										...
										foreach ($farmerData as $item) { ?>
											<tr>
												...
												<td><?php
													...
													?></td>
												<td><a href="<?php echo base_url(); ?>index.php/agency/FarmerController/viewCalender/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->FarmerId)); ?>" class="btn btn-primary btn-rounded btn-floating btn-outline">Storage</a></td>
												<td><a href="<?php echo base_url(); ?>index.php/agency/FarmerController/view/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->FarmerId)); ?>" class="btn btn-info btn-rounded btn-floating btn-outline">View</a></td>
											</tr>
										<?php $c++;
										} ?>
									</tbody>
