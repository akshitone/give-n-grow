...
<head>
	...
	<title>GiveNGrow | Expert Add</title>
	<!-- ================== GOOGLE FONTS ==================-->
					...
					<section class="page-content container-fluid">
							<div class="row">
									<div class="col-md-12">
										<div class="card">
											<div class="card-body">
												<form method="post" id="ExpertForm" action="<?php echo base_url(); ?>index.php/admin/ExpertController/insertData" enctype="multipart/form-data" class="form-horizontal">
											<?php
											...
											<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-md-5">
														<input type="text" id="txtexpertname" name="txtexpertname" placeholder="Expert name" class="form-control input-rounded" autocomplete="family-name">
													</div>
												</div>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Expert Contact</label>
													<div class="col-md-5">
														<input type="text" id="txtexpertno" name="txtexpertno" placeholder="Expert contact" class="form-control input-rounded" autocomplete="family-name">
													</div>
												</div>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Expert Email</label>
													<div class="col-md-5">
														<input type="text" id="txtexpertemail" name="txtexpertemail" placeholder="Expert email" class="form-control input-rounded" autocomplete="family-name">
													</div>
												</div>
												<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-md-5">
														<input type="text" id="txtexpertqualification" name="txtexpertqualification" placeholder="Expert qualification" class="form-control input-rounded" autocomplete="family-name">
													</div>
												</div>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Expert Experience</label>
													<div class="col-md-5">
														<input type="text" id="txtexpertexp" name="txtexpertexp" placeholder="Expert experience in year(s)" class="form-control input-rounded" autocomplete="family-name">
													</div>
												</div>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Username</label>
													<div class="col-md-5">
														<input type="text" id="txtexpertusername" name="txtexpertusername" placeholder="Expert username" class="form-control input-rounded" autocomplete="family-name">
													</div>
												</div>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Password</label>
													<div class="col-md-5">
													<input type="password" id="txtexpertpassword" name="txtexpertpassword" class="form-control input-rounded" id="exampleInputPassword1" autocomplete="current-password" placeholder="Password">
													</div>
												</div>
											</div>
										</div>
