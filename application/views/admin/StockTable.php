...
<head>
	...
	<title>GiveNGrow | Stock Table</title>
	<!-- ================== GOOGLE FONTS ==================-->
									...
									<tbody>
										...
										foreach ($productData as $item) { ?>
											<tr>
												...
												<td><?php if ($item->totalstorage == NULL) {
														echo "No Purchasing";
													} else {
														echo $item->totalstorage;
													}
													?></td>
												<td><?php if ($item->totalsell == NULL) {
														echo "No Selling";
													} else {
														echo $item->totalsell;
													}
													?></td>
												<td><?php $stock = 0;
													$stock = $item->totalstorage - $item->totalsell;
													echo $stock;  ?></td>
