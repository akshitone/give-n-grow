					...
					<section class="page-content container-fluid">
						<div class="row">
							<div class="col">
								<div class="card">
									<div class="card-body">
										<form method="post" enctype="multipart/form-data" id="ProductForm" action="<?php echo base_url(); ?>index.php/admin/ProductController/updateData" class="form-horizontal">
