...
<head>
	...
	<title>GiveNGrow | Final Payment Edit</title>
	<!-- ================== GOOGLE FONTS ==================-->
				...
				<div class="content container-fluid">
					<header class="page-header">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h1 class="separator">Final Payment Edit</h1>
								<nav class="breadcrumb-wrapper" aria-label="breadcrumb">
									<ol class="breadcrumb">
										<li class="breadcrumb-item"><a href="index-2.html"><i class="icon dripicons-home"></i></a></li>
										<li class="breadcrumb-item"><a href="javascript:void(0)">Forms</a></li>
										<li class="breadcrumb-item active" aria-current="page">Final Payment Edit</li>
									</ol>
								</nav>
							</div>
						</div>
					...
					<section class="page-content container-fluid">
						<div class="row">
							<div class="col">
								<div class="card">
									<div class="card-body">
										<form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/admin/FinalPayController/updateData" class="form-horizontal">
											<div class="form-body">
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Request Id</label>
													<div class="col-md-5">
														<select name="txtrequestid" class="form-control input-rounded">
															<option>Select Request Id</option>
															<?php
																foreach($withdrawreqData as $item)
																{
															?>
															<option value="<?php echo $item->RequestId; ?>"><?php echo $item->RequestId; ?></option>
															<?php } ?>
														</select>
													</div>
												</div>
											<?php foreach($finalpayData as $item) { ?>
														<input type="hidden" name="txtpaymentid" value="<?php echo $item->PaymentId; ?>"/>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Amount</label>
													<div class="col-md-5">
														<input type="text" name="txtamt" placeholder="Withdraw amount" value="<?php echo $item->Amount; ?>" class="form-control input-rounded" autocomplete="family-name">
													</div>
												</div>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Remark</label>
													<div class="col-md-5">
														<input type="text" name="txtremark" placeholder="Remark" value="<?php echo $item->Remark; ?>" class="form-control input-rounded" autocomplete="family-name">
													</div>
												</div>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Transaction No.</label>
													<div class="col-md-5">
														<input type="text" name="txttransactionno" placeholder="Transaction no." value="<?php echo $item->TransactionNumber; ?>" class="form-control input-rounded" autocomplete="family-name">
													</div>
												</div>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Payment Type</label>
													<div class="col-md-5">
														<select name="txtpaymenttype" class="form-control input-rounded">
