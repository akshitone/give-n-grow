...
<head>
	...
	<title>GiveNGrow | FAQ Category Edit</title>
	<!-- ================== GOOGLE FONTS ==================-->
				...
				<div class="content container-fluid">
					<header class="page-header">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h1 class="separator">FAq Category Edit</h1>
								<nav class="breadcrumb-wrapper" aria-label="breadcrumb">
									<ol class="breadcrumb">
										<li class="breadcrumb-item"><a href="index-2.html"><i class="icon dripicons-home"></i></a></li>
										<li class="breadcrumb-item"><a href="javascript:void(0)">Forms</a></li>
										<li class="breadcrumb-item active" aria-current="page">FAQ Category Edit</li>
									</ol>
								</nav>
							</div>
						</div>
					...
					<section class="page-content container-fluid">
						...
						<div class="row">
							<div class="col">
								<div class="card">
									<div class="card-body">
										<form method="post" enctype="multipart/form-data" id="FaqCatForm" action="<?php echo base_url(); ?>index.php/admin/FAQCategoryController/updateData" class="form-horizontal">
										<?php foreach($faqcategoryData as $item) { ?>
											<div class="form-body">
								
														<input type="hidden" name="txtfaqcatid" value="<?php echo $item->FAQCatId; ?>"/>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">FAQCategoryName</label>
													<div class="col-md-5">
														<input type="text" id="txtfaqcatname" name="txtfaqcatname" value="<?php echo $item->FAQCatName; ?>" class="form-control input-rounded" autocomplete="family-name">
													</div>
												</div>
												</div>
											<?php } ?>
