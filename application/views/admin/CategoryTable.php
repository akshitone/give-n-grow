...
<head>
	...
	<title>GiveNGrow | Category Table</title>
	<!-- ================== GOOGLE FONTS ==================-->
		...
		<div class="content container-fluid">
			<header class="page-header">
				<div class="d-flex align-items-center">
					<div class="mr-auto">
						<h1 class="separator">Category Tables</h1>
										...
										<tbody>
											...
											foreach ($categoryData as $item) { ?>
												<tr>
													...
													<td><?php echo $item->CategoryType; ?></td>
													<td><?php echo $item->CategoryName; ?></td>
													<td><img src="<?php echo base_url(); ?>/uploads/category/<?php echo $item->CategoryIcon; ?>" style="height:75px; width:75px;" class="w-75 rounded-circle" /></td>
													<td><a href="<?php echo base_url(); ?>index.php/admin/CategoryController/update/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->CategoryId)); ?>" class="btn btn-warning btn-rounded btn-floating btn-outline">Edit</a></td>
													<td><a href="<?php echo base_url(); ?>index.php/admin/CategoryController/delete/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->CategoryId)); ?>" class="btn btn-danger btn-rounded btn-floating btn-outline">Delete</a></button></td>
												</tr>
											<?php $count++;
											}  ?>
										</tbody>
