...
<head>
	...
	<title>GiveNGrow | Agency Add</title>
	<!-- ================== GOOGLE FONTS ==================-->
		...
		<div class="content container-fluid">
			<header class="page-header">
				<div class="d-flex align-items-center">
					<div class="mr-auto">
						<h1 class="separator">Agency Inputs</h1>
						<nav class="breadcrumb-wrapper" aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="index-2.html"><i class="icon dripicons-home"></i></a></li>
								<li class="breadcrumb-item"><a href="javascript:void(0)">Forms</a></li>
								<li class="breadcrumb-item active" aria-current="page">Agency Inputs</li>
							</ol>
						</nav>
					</div>
				</div>
			...
			<section class="page-content container-fluid">
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								<form method="post" id="AgencyForm" action="<?php echo base_url(); ?>index.php/admin/AgencyController/insertData" enctype="multipart/form-data" class="form-horizontal">
									<?php
									...
									<div class="form-body">
										<div class="form-group row">
											...
											<div class="col-md-5">
												<input type="text" id="txtagencyname" name="txtagencyname" placeholder="Agency name" class="form-control input-rounded" autocomplete="given-name">
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-md-5">
												<div class="custom-file">
													<input type="file" id="txtagencyicon" name="txtagencyicon" class="custom-file-input" id="validatedCustomFile" />
									...
									<div class="form-group row">
										...
										<div class="col-md-5">
											<input type="text" id="txtagencycontact" name="txtagencycontact" placeholder="Agency contact no" class="form-control input-rounded" autocomplete="family-name">
										</div>
									</div>
									<div class="form-group row">
										<label class="control-label text-right col-md-3">Email</label>
										<div class="col-md-5">
											<input type="text" id="txtagencyemail" name="txtagencyemail" placeholder="Agency email address" class="form-control input-rounded" autocomplete="email">
										</div>
									</div>
									<div class="form-group row">
										<label class="control-label text-right col-md-3">Agency Code</label>
										<div class="col-md-5">
											<input type="text" id="txtagencycode" name="txtagencycode" placeholder="Agency code" class="form-control input-rounded" autocomplete="family-name">
										</div>
									</div>
									<div class="form-group row">
										<label class="control-label text-right col-md-3">Username</label>
										<div class="col-md-5">
											<input type="text" id="txtagencyusername" name="txtagencyusername" placeholder="Your username" class="form-control input-rounded" autocomplete="family-name">
										</div>
									</div>
									<div class="form-group row">
										<label class="control-label text-right col-md-3">Password</label>
										<div class="col-md-5">
											<input type="password" id="txtagencypassword" name="txtagencypassword" class="form-control input-rounded" id="exampleInputPassword1" autocomplete="current-password" placeholder="Password">
										</div>
									</div>
							</div>
			...
			$("#AgencyForm").validate({
				...
				messages: {
					txtagencyname: {
						...
						nameRegex: "Agency Name must contain only letters & space"
					},
					txtagencyicon: {
