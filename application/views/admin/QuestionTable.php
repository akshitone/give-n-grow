										...
										<div class="card">
											<div class="card-content" style="height:700px;">
												<div class="card-header no-border">
													<h5 class="card-subtitle text-muted" style="margin-bottom:10px;"><b>From:</b>&nbsp;&nbsp;<?php echo $item->FarmerName; ?></h5>
													<h6 class="card-subtitle text-muted"><?php echo $item->CategoryName; ?></h6>
												</div>
												<div class="card-body p-t-0">
													<img class="img-fluid" src="<?php echo base_url(); ?>/uploads/question/<?php echo $item->ImageUrl; ?>" style="height:250px;width:500px;margin-bottom:10px;" alt="Card image cap">
													<h5 class="card-title"><?php echo $item->Title; ?></h5>
													<p class="card-text" style="font-size:12px;margin-bottom:10px;"><?php echo $item->Description; ?></p>
													<p class="card-subtitle text-muted" style="font-size:12px;margin-bottom:10px;"><?php $date=date_create($item->QuestionDateTime); echo date_format($date,"d-m-Y h:i:sA"); ?></p>
													<?php 
																	if($item->IsApprove=="Y")
																	{?>
																	...
																	{?>
																		<span class="badge badge-danger">Pending Answer</span>
																	<?php
																	}
													?>
