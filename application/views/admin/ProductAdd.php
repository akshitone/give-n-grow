					...
					<section class="page-content container-fluid">
						<div class="row">
							<div class="col">
								<div class="card">
									<div class="card-body">
										<form method="post" id="ProductForm" action="<?php echo base_url(); ?>index.php/admin/ProductController/insertData" enctype="multipart/form-data" class="form-horizontal">
											<?php
