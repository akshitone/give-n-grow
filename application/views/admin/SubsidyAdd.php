...
<head>
	...
	<title>GiveNGrow | Subsidy Add</title>
	<!-- ================== GOOGLE FONTS ==================-->
					...
					<section class="page-content container-fluid">
						<div class="row">
							<div class="col">
								<div class="card">
									<div class="card-body">
										<form method="post" id="ProductForm" action="<?php echo base_url(); ?>index.php/admin/SubsidyController/insertData" enctype="multipart/form-data" class="form-horizontal">
											<?php
											...
											<div class="form-body">
												...
												<div class="form-group row">
													...
													<div class="col-md-5">
														<input type="text" id="txttitle" name="txttitle" placeholder="Subsidy title" class="form-control input-rounded" autocomplete="given-name">
													</div>
												</div>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Description</label>
													<div class="col-md-5">
														<textarea id="txtsubsidydesc" name="txtsubsidydesc" placeholder="Subsidy description" class="form-control input-rounded" id="exampleFormControlTextarea1" rows="3"></textarea>
													</div>
												</div>
												<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-md-5">
														<textarea id="txtaddress" name="txtaddress" placeholder="Address" class="form-control input-rounded" id="exampleFormControlTextarea1" rows="3"></textarea>
													</div>
												</div>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Contact</label>
													<div class="col-md-5">
														<input type="text" id="txtcontact" name="txtcontact" placeholder="Contact no" class="form-control input-rounded" autocomplete="family-name">
													</div>
												</div>
												<div class="form-group row">
												...
												<div class="col-md-5">
													<div class="input-group mb-3">
														...
														<input type="text" class="form-control" id="txtapplink" name="txtapplink" aria-describedby="basic-addon3">
													</div>
												</div>
												</div>
											</div>
