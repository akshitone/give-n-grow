...
<head>
	...
	<title>GiveNGrow | Admin Login</title>
	<!-- ================== GOOGLE FONTS ==================-->
	...
	<!-- ======================= THEME COLOR STYLES ===========================-->
	<link rel="stylesheet" href="<?php echo base_url(); ?>admin_plugin/assets/css/layouts/vertical/themes/theme-h.css">
</head>
...
<body>
	...
	<div class="container">
		<form class="sign-in-form" method="post" action="<?php echo base_url(); ?>index.php/admin/LoginController/dologin">
			<div class="card">
				<div class="card-body">
				<?php
				...
				<?php } ?>
					...
					<h5 class="sign-in-heading text-center m-b-20">Sign in to your account &nbsp;<span class="badge badge-primary">ADMIN</span> </h5>
					<div class="form-group">
						<label for="inputEmail" class="sr-only">Email address</label>
						<input type="email" name="txtemail" id="inputEmail" class="form-control" placeholder="Email address" required="">
					</div>
