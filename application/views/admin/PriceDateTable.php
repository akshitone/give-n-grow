...
<head>
	...
	<title>GiveNGrow | Price Date Table</title>
	<!-- ================== GOOGLE FONTS ==================-->
		...
		<div class="content container-fluid">
			<header class="page-header">
				<div class="d-flex align-items-center">
					<div class="mr-auto">
						<h1 class="separator">Price date Data</h1>
						<nav class="breadcrumb-wrapper" aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="index-2.html"><i class="icon dripicons-home"></i></a></li>
								<li class="breadcrumb-item"><a href="javascript:void(0)">Tables</a></li>
								<li class="breadcrumb-item active" aria-current="page">Price date Data</li>
							</ol>
						</nav>
					</div>
				</div>
							...
							<div class="card-body">
								<table id="bs4-table" class="table table-striped table-bordered" style="width:100%">
									...
									<tbody>
										<?php
										$c = 1;
										foreach ($pricedateData as $item) { ?>
											<tr>
												<td><?php echo $c; ?></td>
												<td><?php echo $item->ProductName; ?></td>
												<td><?php $date = date_create($item->PriceDate);
													echo date_format($date, "d-m-Y"); ?></td>
												<td>&#8377;<?php echo $item->BuyerPrice1; ?></td>
												<td>&#8377;<?php echo $item->SellerPrice1; ?></td>
												<td>&#8377;<?php echo $item->BuyerPrice2; ?></td>
												<td>&#8377;<?php echo $item->SellerPrice2; ?></td>
												<td>&#8377;<?php echo $item->BuyerPrice3; ?></td>
												<td>&#8377;<?php echo $item->SellerPrice3; ?></td>
												<td><a href="<?php echo base_url(); ?>index.php/admin/PriceDateController/update/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->PriceId)); ?>" class="btn btn-warning btn-rounded btn-floating btn-outline">Edit</a></td>
												<td><a href="<?php echo base_url(); ?>index.php/admin/PriceDateController/delete/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->PriceId)); ?>" class="btn btn-danger btn-rounded btn-floating btn-outline">Delete</a></td>
											</tr>
										<?php $c++;
										} ?>
									</tbody>
