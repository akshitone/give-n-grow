					...
					<section class="page-content container-fluid">
							<div class="row">
									<div class="col-md-12">
										<div class="card">
											<div class="card-body">
												<form method="post" id="FaqForm" action="<?php echo base_url(); ?>index.php/admin/FAQController/insertData"  class="form-horizontal">
											<?php
											...
											<div class="form-body">
												...
												<div class="form-group row">
													...
													<div class="col-md-5">
														<textarea id="txtquestion" name="txtquestion" placeholder="Question" class="form-control input-rounded" id="exampleFormControlTextarea1" rows="3"></textarea>
													</div>
												</div>
												<div class="form-group row">
													<label class="control-label text-right col-md-3">Answer</label>
													<div class="col-md-5">
														<textarea id="txtanswer" name="txtanswer" placeholder="Answer" class="form-control input-rounded" id="exampleFormControlTextarea1" rows="3"></textarea>
													</div>
												</div>
											</div>
