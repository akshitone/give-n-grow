...
<head>
	...
	<title>GiveNGrow | Withdraw Request Table</title>
	<!-- ================== GOOGLE FONTS ==================-->
		...
		<div class="content container-fluid">
			<header class="page-header">
				<div class="d-flex align-items-center">
					<div class="mr-auto">
						<h1 class="separator">Withdraw Request Data</h1>
						<nav class="breadcrumb-wrapper" aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="index-2.html"><i class="icon dripicons-home"></i></a></li>
								<li class="breadcrumb-item"><a href="javascript:void(0)">Tables</a></li>
								<li class="breadcrumb-item active" aria-current="page">Withdraw Request Data</li>
							</ol>
						</nav>
					</div>
				</div>
											...
											<tr>
												...
												<td><?php
													...
													<?php
														...
														<a href="<?php echo base_url(); ?>index.php/admin/FinalPayController/add/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->RequestId)); ?>"><span class="badge badge-danger">Pending</span></a>
													<?php
													}
													?></td>
												<td><a href="<?php echo base_url(); ?>index.php/admin/WithdrawReqController/delete/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->RequestId)); ?>" class="btn btn-danger btn-rounded btn-floating btn-outline">Delete</a></td>
											</tr>
										<?php $c++;
										} ?>
									</tbody>
