...
<head>
	...
	<title>GiveNGrow | FAQ Category Table</title>
	<!-- ================== GOOGLE FONTS ==================-->
		...
		<div class="content container-fluid">
			<header class="page-header">
				<div class="d-flex align-items-center">
					<div class="mr-auto">
						<h1 class="separator">FAQ Category Tables</h1>
						<nav class="breadcrumb-wrapper" aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="index-2.html"><i class="icon dripicons-home"></i></a></li>
								<li class="breadcrumb-item"><a href="javascript:void(0)">Tables</a></li>
								<li class="breadcrumb-item active" aria-current="page">FAQ Category Tables</li>
							</ol>
						</nav>
					</div>
				</div>
								...
								<table id="bs4-table" class="table table-striped table-bordered" style="width:100%">
									...
									<tbody>
										...
										foreach ($faqcategoryData as $item) { ?>
											<tr>
												<td><?php echo $item->FAQCatId; ?></td>
												<td><?php echo $item->FAQCatName; ?></td>

												<td><a href="<?php echo base_url(); ?>index.php/admin/FAQCategoryController/update/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->FAQCatId)); ?>" class="btn btn-warning btn-rounded btn-floating btn-outline">Edit</a></td>
												<td><a href="<?php echo base_url(); ?>index.php/admin/FAQCategoryController/delete/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->FAQCatId)); ?>" class="btn btn-danger btn-rounded btn-floating btn-outline">Delete</a></td>
											</tr>
										<?php $c++;
										} ?>
									</tbody>
