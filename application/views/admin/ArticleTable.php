							...
							<div class="card">
								<div class="card-content" style="height:900px;">
									...
									<div class="card-body p-t-0">
										...
										<p class="card-subtitle text-muted" style="font-size:12px;margin-bottom:10px;"><?php $date = date_create($item->ArticleDateTime);
																														echo date_format($date, "d-m-Y h:i:sA"); ?></p>
										<?php
										if ($item->IsApprove == "Y") { ?>
											<a href="<?php echo base_url(); ?>index.php/admin/ArticleController/UpdateToNo/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->ArticleId)); ?>"> <span class="badge badge-success">Approve</span></a>
										<?php
										} else { ?>
											<a href="<?php echo base_url(); ?>index.php/admin/ArticleController/UpdateToYes/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->ArticleId)); ?>"><span class="badge badge-danger">Pending</span></a>
										<?php
										}
										?>
									</div>
