...
<head>
	...
	<title>GiveNGrow | FAQ Table</title>
	<!-- ================== GOOGLE FONTS ==================-->
									...
									<tbody>
										...
										foreach ($faqData as $item) { ?>
											<tr>
												...
												<td><a href="<?php echo base_url(); ?>index.php/admin/FAQController/update/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->FAQId)); ?>" class="btn btn-warning btn-rounded btn-floating btn-outline">Edit</a></td>
												<td><a href="<?php echo base_url(); ?>index.php/admin/FAQController/delete/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->FAQId)); ?>" class="btn btn-danger btn-rounded btn-floating btn-outline">Delete</a></td>
											</tr>
										<?php $c++;
										} ?>
									</tbody>
