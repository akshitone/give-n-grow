								...
								<div class="profile-card text-center">
									<?php foreach ($expertData as $item) { ?>
										<div class="thumb-xl member-thumb m-b-10 center-block">
											<img src="<?php echo base_url(); ?>/uploads/Expert/<?php echo $item->ExpertIcon; ?>" style="height:300px; width:300px;" class="rounded-circle img-thumbnail" alt="profile-image">
										</div>
										<div class="">
											<h5 class="m-b-5"><?php echo $item->ExpertName; ?></h5>
											<p class="text-muted"><?php echo $item->ExpertUserName; ?></p>
										</div>
										<ul class="list-reset text-left m-t-40">

											<li style="margin-bottom:10px;" class="text-muted"><strong>Mobile:</strong><span class="m-l-15"><?php echo $item->ExpertContact; ?></span></li>
											<li style="margin-bottom:10px;" class="text-muted"><strong>Email:</strong> <span class="m-l-15"><?php echo $item->Email; ?></span></li>
											<li style="margin-bottom:10px;" class="text-muted"><strong>Active:</strong> <span class="m-l-15"><?php
																																				if ($item->IsActive == "Y") { ?>
									...
									<div class="card">
										<div class="card-content">
											<div class="card-header no-border">
												<h5 class="card-subtitle text-muted" style="margin-bottom:10px;"><b>From:</b>&nbsp;&nbsp;<?php echo $item->ExpertName; ?></h5>
												<h6 class="card-subtitle text-muted"><?php echo $item->CategoryName; ?></h6>
											</div>
											<div class="card-body p-t-0">
												<img class="img-fluid" src="<?php echo base_url(); ?>/uploads/article/<?php echo $item->Image1; ?>" style="height:200px;width:500px;margin-bottom:10px;" alt="Card image cap">
												<img class="img-fluid" src="<?php echo base_url(); ?>/uploads/article/<?php echo $item->Image2; ?>" style="height:200px;width:500px;margin-bottom:10px;" alt="Card image cap">
												<h5 class="card-title"><?php echo $item->Title; ?></h5>
												<p class="card-text" style="font-size:12px;margin-bottom:5px;"><?php echo $item->Description; ?></p>
												<p class="card-subtitle text-muted" style="margin-bottom:10px;"><?php $date = date_create($item->ArticleDateTime);
																												echo date_format($date, "d/m/Y h:i:sA");; ?></p>
												<?php
												if ($item->IsApprove == "Y") { ?>
													<a href="<?php echo base_url(); ?>index.php/expert/ArticleController/UpdateToNo/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->ArticleId)); ?>"> <span class="badge badge-success">Approve</span></a>
												<?php
												} else { ?>
													<a href="<?php echo base_url(); ?>index.php/expert/ArticleController/UpdateToYes/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->ArticleId)); ?>"><span class="badge badge-danger">Pending</span></a>
												<?php
												}
												?>
											</div>
