...
<head>
	...
	<title>GiveNGrow | Withdraw Request Edit</title>
	<!-- ================== GOOGLE FONTS ==================-->
					...
					<section class="page-content container-fluid">
						<div class="row">
							<div class="col">
								<div class="card">
									<div class="card-body">
										<form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/admin/WithdrawReqController/updateData" class="form-horizontal">
												<div class="form-body">
											...
											<?php foreach($withdrawreqData as $item) { ?>
													<input type="hidden" name="txtrequestid" value="<?php echo $item->RequestId; ?>"/>
												<div class="form-group row">
