									...
									<tbody>
										...
										foreach ($buyerData as $item) { ?>
											<tr>
												...
												<td><?php
													if ($item->Status == "Y") { ?>
														<a href="<?php echo base_url(); ?>index.php/admin/BuyerController/UpdateToNo/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->BuyerId)); ?>"> <span class="badge badge-success">Approve</span></a>
													<?php
													} else { ?>
														<a href="<?php echo base_url(); ?>index.php/admin/BuyerController/UpdateToYes/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->BuyerId)); ?>"><span class="badge badge-danger">Pending</span></a>
													<?php
													}
													?></td>
												<td><a href="<?php echo base_url(); ?>index.php/admin/BuyerController/view/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->BuyerId)); ?>" class="btn btn-info btn-rounded btn-floating btn-outline">View</a></td>
												<td><a href="<?php echo base_url(); ?>index.php/admin/BuyerController/update/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->BuyerId)); ?>" class="btn btn-warning btn-rounded btn-floating btn-outline">Edit</a></td>
												<td><a href="<?php echo base_url(); ?>index.php/admin/BuyerController/delete/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->BuyerId)); ?>" class="btn btn-danger btn-rounded btn-floating btn-outline">Delete</a></td>
											</tr>
										<?php $c++;
										} ?>
									</tbody>
