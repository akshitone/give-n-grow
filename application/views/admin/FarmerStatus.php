			...
			<section class="page-content container-fluid">
				<div class="row">
					<div class="col">
						<div class="card">
							<div class="card-body">
								<form method="post" enctype="multipart/form-data" id="FarmerForm" class="form-horizontal" action="<?php echo base_url(); ?>index.php/admin/FarmerController/UpdateToYes">
									<?php foreach ($farmerStatusData as $item) { ?>
										<div class="form-body">
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" id="txtfarmername" name="txtfarmername" value="<?php echo $item->FarmerName; ?>" placeholder="Farmer name" class="form-control input-rounded" autocomplete="given-name" readonly="readonly">
												</div>
											</div>
											<div class="form-group row">
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" id="txtfarmercontact" name="txtfarmercontact" value="<?php echo $item->FarmerContact; ?>" placeholder="Contact no" class="form-control input-rounded" autocomplete="family-name" readonly="readonly">
												</div>
											</div>
											<div class="form-group row">
												<label class="control-label text-right col-md-3">Address</label>
												<div class="col-md-5">
													<textarea id="txtfarmeraddress" name="txtfarmeraddress" placeholder="Address" class="form-control input-rounded" id="exampleFormControlTextarea1" rows="3" readonly="readonly"><?php echo $item->FarmerAddress; ?></textarea>
												</div>
											</div>
											<div class="form-group row">
												<label class="control-label text-right col-md-3">Password</label>
												<div class="col-md-5">
													<input type="password" id="txtfarmerpassword" name="txtfarmerpassword" value="<?php echo $item->Password; ?>" class="form-control input-rounded" id="exampleInputPassword1" autocomplete="current-password" readonly="readonly" placeholder="Password">
												</div>
											</div>
											<div class="form-group row">
												<label class="control-label text-right col-md-3">Farmer Code</label>
												<div class="col-md-5">
													<input type="text" id="txtfarmercode" name="txtfarmercode" placeholder="Farmer code" class="form-control input-rounded" autocomplete="family-name">
												</div>
											</div>
											<div class="form-group row">
												<label class="control-label text-right col-md-3">Aadhar No.</label>
												<div class="col-md-5">
													<input type="text" id="txtfarmeraadharno" name="txtfarmeraadharno" readonly="readonly" value="<?php echo $item->AadharNumber; ?>" placeholder="Aadhar Card no" class="form-control input-rounded" autocomplete="family-name">
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-md-5">
													<div class="custom-file">
														<img src="<?php echo base_url(); ?>/uploads/id/<?php echo $item->AadharFrontImage; ?>" style="height:75px; width:75px;" class="w-75 rounded-circle" />
													</div>
												</div>
											</div><br>
											<div class="form-group row">
												...
												<div class="col-md-5">
													<div class="custom-file">
														<img src="<?php echo base_url(); ?>/uploads/id/<?php echo $item->AadharBackImage; ?>" style="height:75px; width:75px;" class="w-75 rounded-circle" />
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-md-12">
											<div class="row">
												<div class="offset-sm-3 col-md-5">
													<button type="submit" id="btnapprove" name="btnapprove" class="btn btn-primary btn-rounded">Approve</button>
													<a href="<?php echo base_url(); ?>index.php/admin/FarmerController/UpdateToReject/<?php echo str_replace("/", "-", $this->encryption->encrypt($item->FarmerId)); ?>/<?php echo $item->FarmerContact; ?>" id="btnreject" name="btnreject" class="btn btn-danger btn-rounded">Reject</a>
												</div>
											</div>
										</div>
									</div>
