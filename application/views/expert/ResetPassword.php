...
<head>
	...
	<!-- ======================= THEME COLOR STYLES ===========================-->
	<link rel="stylesheet"
		href="<?php echo base_url(); ?>admin_plugin/assets/css/layouts/vertical/themes/theme-b.css">
</head>
...
<body class="content-menu">
    ...
    ?>
		<form class="sign-in-form" method="post" enctype="multipart/form-data"
			action="<?php echo base_url(); ?>index.php/expert/ExpertLoginController/updatepassword">
			<div class="card">
				<div class="card-body">
					...
					<div class="form-group">
						<input type="text" name="txtemail" class="form-control" readonly="readonly"
							value="<?php echo $this->session->userdata('forgotemail'); ?>" /><br>
					...
					<div class="form-group">
						...
						<input type="password" name="txtconfirmpassword" id="inputConfirmPassword" class="form-control"
					...
					<button class="btn btn-primary btn-rounded btn-floating btn-lg btn-block" type="submit">Reset
						Password</button>
				</div>
			</div>
		</form>
