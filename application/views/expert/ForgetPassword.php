...
<body class="content-menu">
	...
	?>
		<form class="sign-in-form" method="post" action="<?php echo base_url(); ?>index.php/expert/ExpertLoginController/checkEmailAddress">
			<div class="card">
				<div class="card-body">
					...
					<div class="form-group">
						...
						<input name="txtemail" type="email" id="inputEmail" class="form-control" placeholder="Email address" >
					</div>
